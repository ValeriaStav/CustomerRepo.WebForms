    ...
    public class CustomerRepository : BaseRepository, IRepository<Customer>
    {
        ...
        public void Update(Customer entity)
        {
            using (var connection = GetConnection())
            {
                ...
                var command = new SqlCommand("UPDATE [Customer] SET FirstName = @FirstName, LastName = @LastName, CustomerPhoneNumber = @CustomerPhoneNumber, CustomerEmail = @CustomerEmail, TotalPurchaseAmount = @TotalPurchaseAmount WHERE CustomerId = @CustomerId", connection);
